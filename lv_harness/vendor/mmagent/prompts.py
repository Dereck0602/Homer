...
[
	{{"question": "what's the man doing?", "answer": "he fixing the car.", "reasoning": "Need to find the scene in the video where the man is fixing the car."}},
	{{"question": "why she looks angry?", "answer": "because someone take her bag.", "reasoning": "Need to find in the video the reason why the woman is angry."}}
]
