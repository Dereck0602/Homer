#!/bin/bash
# ============================================================
# Video-MME batch-level self-evolution evaluation script
#
# Usage examples:
#   bash run_videomme_batch.sh
#   NUM_QUESTIONS=128 BATCH_SIZE=64 bash run_videomme_batch.sh
#   MODE=streaming bash run_videomme_batch.sh
# ============================================================
...
# Video-MME is multiple choice, defaulting to string matching.
...
VISUAL_CLIPS_ROOT="${VISUAL_CLIPS_ROOT:-${VIDEOMME_DATA_ROOT}/clips}"
...
EVOLUTION_DIR="${EVOLUTION_DIR:-${LV_HARNESS_PATH}/data/evolution/videomme_${EVOLUTION_SUFFIX}_${KF_TAG}_${EVO_MODE_TAG}_${SKILL_INSTRUCTIONS_MODEL}}"
...
CLIP_DIR_TEMPLATE="${CLIP_DIR_TEMPLATE:-${VIDEOMME_DATA_ROOT}/clips/{video_name}}"
EG_INCREMENTAL="${EG_INCREMENTAL:-true}"
EG_UPDATE_INTERVAL="${EG_UPDATE_INTERVAL:-10}"
EG_MODEL="${EG_MODEL:-gemini-3-flash-preview}"
MEMORY_CACHE_DIR="${MEMORY_CACHE_DIR:-${LV_HARNESS_PATH}/data/videomme_memory_cache}"
...
# ---- Run ----
echo "============================================================"
echo "Video-MME batch-level self-evolution evaluation (mode=${MODE})"
